...
policy: "### Why you are receiving this document
  ...
  * How you can make a complaint and our compensation arrangements
  ...
  <table style=\"background-color:#f2f7f2;\">\ 

  <tr>\ 

  <h3>Not Independent</h3>\ 

  <p>Clients may elect for Walbrook to receive regulated commissions from life
  ...
  *Fee for Service, where you pay a fixed dollar or percentage-based fee for
  the services that we agree to provide;
  ...
  *A combination of Fee for Service and Commission.
  ...
  <td valign=\"top\"><p>Following the first meeting, we will agree a flat fee
  for the preparation of your initial Statement of Advice. Please note that
  there is no charge for the first meeting.</p>
  ...
  * The minimum initial advice fee for scaled or single issue advice is AUD
  ...
  <p>Please note, we do not charge initial advice fees under the Accelerate
  ...
  calculate an implementation fee. This fee will be calculated on a time basis.
  If you request our assistance to implement the recommendations made, we will
  charge the implementation fee. We will disclose this fee and the
  implementation services it covers in the Statement of Advice.
  ...
  * Setting up initial/ongoing account contributions
  ...
  <p>Please note, we do not charge advice implementation fees under the
  Accelerate and Support packages outlined below. </td></p></tr>
